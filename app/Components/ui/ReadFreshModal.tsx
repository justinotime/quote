...
interface ReadFreshModalProps {
  open: boolean;
  onClose: () => void;
  onSignInClick: () => void;
}

const ReadFreshModal: React.FC<ReadFreshModalProps> = ({ open, onClose, onSignInClick }) => {
  ...
  return (
    <AnimatePresence>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="read-fresh-modal-title"
      >
        <motion.div
        ...
        >
          ...
          <h2 id="read-fresh-modal-title" className="text-2xl font-bold mb-0 text-center italic">Join Quote.</h2>
